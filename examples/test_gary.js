...
//  console.log('on-discover:' + peripheral);
  ...
  peripheral.connect(function(error){
    ...
    peripheral.discoverServices(['13333333333333333333333333330001'], function(error, services) {
//    peripheral.discoverServices(['180f'], function(error, services) {
      console.log('discover temperature service ship');
      var temperatureService = services[0];
      console.log('discover temperature service' + temperatureService);
...
//      temperatureService.discoverCharacteristics(['2a19'], function(error, characteristics) {
	...
	//    console.log('the humidity', (data[6] * 256 + data[5]) / 10);
	    ...
	    sensor.publish('$aws/things/ituthings3/shadow/update', JSON.stringify("{\"state\":{\"reported\":{" +
	    	pubData + "}}}"
	    ));
